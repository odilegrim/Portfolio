...
The precision rates are very high for all of the categories, as you can see in the table on the bottom. The categories I divided the music into are thus very distinguishable from each other, especially when filtering out the right elements (even without doing this the scores are still relatively high).
