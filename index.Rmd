...
The main difference we can see between te popular and not popular songs, is that the popular ones have more distinct areas where a certain pitch is absent, as can be seen by the **black areas**. The high magnitude areas are also a lot clearer and more distinct than in the unpopular songs. *CYFMH* has a clear focus on E and C and *Kinglsayer* is focused on C, C#/Db and B. The unpopular songs basically have **more of everything**, you would be able to make out some areas of focus, but the chromagrams have **a lot less contrast** in them.
...
*After [plotting the energy and valence](https://odilegrim.github.io/Portfolio/#general) of Bring Me The Horizon's songs over the years, it gave me some insight into which songs were on the outer ends of the 'emotional spectrum'. Because of this I decided to take a closer look at the happiest and the saddest songs in their repertoire.*
...
***
*add energy/valence/duration plots for clarification?*
...
* seems to have more variation

* is "happier" (higher valence)

* seems to be less bright

* seems to be louder 

**old music**

* Sempiternal is a "transitioning" album: still fits into the old, but has a lot of new features.

**Experimental music**

* is defnitely different from everything else
