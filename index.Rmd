...
***
A cepstogram of the song *Sleep With One Eye Open*, which is the song with values closest to the mean valence, energy and speechiness in the "Old Music" category.
...
***
A cepstogram of the song *Ouch*, which is the song with values closest to the mean valence, energy and speechiness in the "New Music" category.


### The most popular song in BMTH's entire repertoire and it's self-similarity (homework week 8)
```{r}
library(spotifyr)
library(ggplot2)
library(tidyverse)
...
***
A self-similarity matrix for Bring Me The Horizon's most popular song *Can You Feel My Heart*

### An introduction to what this portfolio is about
